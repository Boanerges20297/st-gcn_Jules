 -   F o c o   a l t e r a d o   p a r a   * * S e n t i n e l a   V 4   ( E l i t e   P 1 0 ) * * ,   q u e   o p e r a   e m   r a i o s   d e   5 0 0 m   p a r a   l o c a l i z a � � o   d e   r i s c o   C V L I . 
 
 # # #   I m p l e m e n t a � � o 
...
 -   * * E x p o r t a � � o : * *   G e r a d o   \ 	 o p 3 0 _ e l i t e _ p 1 0 . g e o j s o n \   c o m   o s   3 0   l o c a i s   d e   m a i o r   c r i t i c i d a d e   g r a n u l a r . 
 
 # # #   R e s u l t a d o s 
 -   * * F i d e l i d a d e : * *   M a p e a m e n t o   e x a t o   d o s   h o t s p o t s   d e   5 0 0 m   ( e x :   C a r i r �   Z 4   c o m   r i s c o   9 5 . 0   n o   t o p o ) . 
 -   * * I n t e g r a � � o : * *   A r q u i v o s   d i s p o n i b i l i z a d o s   e m   \ s t a t i c _ e x p o r t / d a t a _ t a c t i c a l / \   p a r a   c a p t u r a   d e   s c r e e n s h o t   o p e r a c i o n a l . 
...
- **Scheduler**: onecycle
- **M�trica de Avalia��o**: P@10

### 3. Resultados
- **Colapso de Valida��o:** O modelo sofreu um colapso r�pido de performance na valida��o (Val P@10 caiu de 26.81% na �poca 1 para 21.18% na �poca 5). O aprendizado foi excessivamente agressivo sob a taxa lr=0.001 e grad_accum=16, gerando instabilidade estat�stica nas camadas de BatchNorm com batch size efetivo de 1. O treino foi interrompido manualmente.
...
### 1. Análise Criteriosa Realizada
...
`grad_accum` acumula gradientes mas o BatchNorm calcula estatísticas
a cada forward com N=1 — running_mean/var ficam impossíveis de estimar.
...
**42% amostras val com <10 eventos** — P@10 instável por definição.

### 2. Patches Aplicados

- **PATCH 1 (architectures.py):** `FastRelationalGCN.bn` → `nn.LayerNorm` (estável com batch=1)
- **PATCH 2 (architectures.py):** `PureSTGCNBlock.out_norm` → `nn.InstanceNorm2d(affine=True)` (estável com batch=1)
- **PATCH 3 (train_all_specialists.py):** Val loop filtra amostras com `n_events >= k_eval` (P@10 mais estável)
...
- **Épocas**: 30
- **Patience**: 10
- **Grad Accumulation**: 1 (desnecessário com normas estáveis)
- **Janela**: 90 dias
- **Scheduler**: onecycle
...
## Tentativa 122 — RESULTADO FINAL

### Conclusao

**Problema identificado:** Overfitting. O patch do BatchNorm resolveu o colapso subito (causado por running stats divergentes), porem expôs o problema real: loss de treino cai consistentemente (8.47 -> 4.67) mas P@10 validacao regride junto (31.71% -> 18.53%). O modelo decora o ranking de treino em vez de generalizar.
